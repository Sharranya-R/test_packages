...
from test_packages.hub import HUB_WEB_ROOT, PREFIX, HUBTrainingSession, events
from test_packages.utils import LOGGER, RANK, SETTINGS
...
def on_fit_epoch_end(trainer):
    ...
    if session:
        ...
        if trainer.epoch == 0:
            from test_packages.utils.torch_utils import model_info_for_loggers
