...
from test_packages.utils import LOGGER, TQDM, checks, clean_url, emojis, is_online, url2file
...
def attempt_download_asset(file, repo="ultralytics/assets", release="v8.2.0", **kwargs):
    ...
    Example:
        ...
        ```
    """
    from test_packages.utils import SETTINGS  # scoped for circular import
